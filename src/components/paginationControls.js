...
import { boolType, funcType, numberType } from '../config/proptypes';
import '../css/pagination.css';

const PaginationControls = ({ count, fetch, forceVisibility, limit, loading, oneWay, page }) => (
