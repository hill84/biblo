...
export const genres = [
  { id: "ac", color: '#62A7B5', name: "Architettura" },
  { id: "ar", color: '#539E91', name: "Arte" },
  { id: "av", color: '#74C493', name: "Avventura" },
  { id: "bi", color: '#c5e1a5', name: "Biografie e autobiografie" },
  { id: "cu", color: '#e6ee9c', name: "Cucina" },
  { id: "ef", color: '#52b586', name: "Economia e finanza" }, 
  { id: "er", color: '#E279A3', name: "Erotico" },
  { id: "fa", color: '#F19670', name: "Famiglia e relazioni" },
  { id: "sf", color: '#7986cb', name: "Fantascienza" },
  { id: "fy", color: '#bb7ed6', name: "Fantasy" },
  { id: "fi", color: '#de7070', name: "Filosofia" },
  { id: "fu", color: '#E09A6A', name: "Fumetti e Graphic novel" },
  { id: "gl", color: '#FFCA28', name: "Giallo" },
  { id: "ho", color: '#d45858', name: "Horror" },
  { id: "in", color: '#C3C7CA', name: "Informatica" },
  { id: "ju", color: '#4db6ac', name: "Per ragazzi" },
  { id: "ms", color: '#5c8e8b', name: "Medicina e salute" },
  { id: "mi", color: '#546E7A', name: "Mistero" },
  { id: "mu", color: '#7C9FB0', name: "Musica" },
  { id: "na", color: '#5698C4', name: "Narrativa" },
  { id: "po", color: '#74B8BF', name: "Poesia" },
  { id: "pl", color: '#9ABF88', name: "Politica" },
  { id: "ps", color: '#7DCEAB', name: "Psicologico" },
  { id: "re", color: '#ffe082', name: "Religione e spiritualità" },
  { id: "ro", color: '#ef9a9a', name: "Rosa" },
  { id: "sa", color: '#93B0D0', name: "Saggistica" },
  { id: "sc", color: '#51b9de', name: "Scienza" },
  { id: "ss", color: '#d7A96D', name: "Scienze sociali" },
  { id: "st", color: '#b98054', name: "Storico" },
  { id: "te", color: '#8d6e63', name: "Teatro" },
  { id: "th", color: '#bba466', name: "Thriller" },
  { id: "um", color: '#9ec16c', name: "Satira e umorismo" },
  { id: "vi", color: '#32ccc3', name: "Viaggi" }
];
