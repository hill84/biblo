  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* PRIVATE ROOTS */}
        <Route path='admin' element={() => isAuth ? <Admin /> : <Navigate to='/login' />} /> {{/* exact */}}
        <Route path='admin/:tab' element={() => isAuth ? <Admin /> : <Navigate to='/login' />} />
        <Route path='books/add' element={() => isAuth ? <AddBook /> : <Navigate to='/login' />} />
        <Route path='challenge' element={() => isAuth ? <Challenge /> : <Navigate to='/login' />} />
        <Route path='new-book' element={() => isAuth ? <NewBook /> : <Navigate to='/login' />} />
